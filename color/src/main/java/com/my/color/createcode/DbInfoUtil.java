...
public class DbInfoUtil {  
     ...
     * @return Map集合 
     */  
    public static List<String> getTableInfo(String driver,String url,String user,String pwd,String table){  
    ...
    public static void main(String[] args) {  
        ...
        String user = "root"; 
        String pwd = "root"; 
        String url = "jdbc:mysql://localhost/hderp" 
                + "?useUnicode=true&characterEncoding=UTF-8"; 
        String table = "e_material_purchase_details"; 
