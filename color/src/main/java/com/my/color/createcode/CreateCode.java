...
public class CreateCode {
	// 1.那些domain需要生成代码
	private String[] domains = { "SalaryManage" };
	private String[] domainName = { "班级管理" };
	private String[] projectPakcageName = {"manage"};
	private String[] packagePath = {"com.my.color.manage"};
	private String[] tableName = {"e_salary_manage"};
	private String[] lowTableName = {"salaryManage"};
	private String[] pageName = {"salaryManage"};
	// 2.定义固定的目录路径:都是使用相对路径,规范：路径前面都不加/,路径的后面都加/
	private static final String SRC = "src/main/java/";
	private static final String PACKAGE = "com/my/color/manage/";//相应的类的路径
	...
	public void create(String table) throws Exception {
        ...
        String domainPackageName = "com.my.color.manage.dao.po.SalaryManage";
