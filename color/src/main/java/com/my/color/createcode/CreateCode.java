...
public class CreateCode {
	// 1.那些domain需要生成代码
	private String[] domains = { "WaitDeal" };
	private String[] domainName = { "请假待办" };
	private String[] projectPakcageName = {"wait"};
	private String[] packagePath = {"com.my.color.wait"};
	private String[] tableName = {"e_wait_deal"};
	private String[] lowTableName = {"waitDeal"};
	private String[] pageName = {"waitDeal"};
	// 2.定义固定的目录路径:都是使用相对路径,规范：路径前面都不加/,路径的后面都加/
	private static final String SRC = "src/main/java/";
	private static final String PACKAGE = "com/my/color/wait/";//相应的类的路径
	...
	public void create(String table) throws Exception {
        ...
        String domainPackageName = "com.my.color.wait.dao.po.WaitDeal";
